...
Во вкладке **Массовые рассылки** сводки по всем выпускам собраны в одной таблице — её можно экспортировать в форме xlsx или csv. В таблице есть поиск — искать отчёты можно по следующим параметрам:
