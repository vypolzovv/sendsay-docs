...
Для получения доступа к SMTP-гейту <SupportLink>напишите в чат поддержки</SupportLink> или вашему менеджеру. Вам зададут несколько вопросов о ваших рассылках и после этого выдадут параметры подключения.
