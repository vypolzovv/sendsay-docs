...
Отправьте себе [тестовую копию письма](https://docs.sendsay.ru/email-campaigns/create-your-campaign/how-to-send-email-campaign#4-отправьте-себе-тестовую-копию), — чтобы убедиться, что всё отображается так, как вы ожидаете.
