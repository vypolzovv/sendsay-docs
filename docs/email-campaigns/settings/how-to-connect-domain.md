...
![Return Path](./assets\how-to-connect-domain/return-path.gif) <br/>
...
![Unverified sender](./assets\how-to-connect-domain/unverified-sender.png) <br/>
...
![Create new domain](./assets\how-to-connect-domain/create-new-domain.gif) <br/>
...
![DKIM key](./assets\how-to-connect-domain/dkim-key.png) <br/>
