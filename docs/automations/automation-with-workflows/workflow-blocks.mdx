...
**Добавление в список при импорте** — сработает, только при включенной галочке «Учитывать изменение данных для запуска сценариев» в дополнительных настройках импорта, когда:
...
Событие **Добавление в список при импорте** можно указать только в качестве Стартового.
