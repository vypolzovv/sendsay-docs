...
**Клик по&nbsp;ссылке** ([описание в&nbsp;API](https://sendsay.ru/api/api.html#Клик-по-ссылке))&nbsp;&mdash; Событие наступит, когда подписчик кликнет по&nbsp;указанной ссылке в&nbsp;сообщении, ранее отправленном в&nbsp;этом сценарии.

<p align="center">
  <img width="50%" src={clickOnLink} alt="click on the link" />
</p>

Если это Событие добавлено в&nbsp;качестве Стартового, то&nbsp;оно отреагирует на&nbsp;клик по&nbsp;указанной ссылке в&nbsp;массовой рассылке, отправленной обычным способом,&nbsp;&mdash; после этого подписчик попадет в&nbsp;сценарий. При необходимости можно указать, чтобы событие отслеживало клики по любым ссылкам.
