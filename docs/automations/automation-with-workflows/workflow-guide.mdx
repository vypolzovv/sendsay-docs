...
2. В&nbsp;появившемся окне выберите нужную вкладку:
   ...
   - **указать вручную**, если хотите добавить подписчиков из базы или исключить конкретных участников сценария. Выберите тип контакта для добавления:
     ![Contact type](/img/automations/automation-with-workflows/workflow-guide/contact-type.png)
     Затем введите нужные адреса контактов, либо нажмите ссылку «Выбрать из базы подписчиков» внизу поля;
