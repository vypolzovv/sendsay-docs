...
3. Выберите нужное действие:
   ...
   - **указать вручную**, если хотите добавить подписчиков из базы или исключить конкретных участников сценария. Затем введите нужные адреса контактов, либо нажмите ссылку «Выбрать из...» внизу поля;
