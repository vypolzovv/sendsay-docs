...
![Workflow creation](/img/automations/automation-with-workflows/workflow-guide/workflow-creation.png) <br/>
...
2. В&nbsp;появившемся окне выберите нужную вкладку:
   ...
   - **указать вручную**, если хотите добавить подписчиков из базы или исключить конкретных участников сценария. Выберите тип контакта для добавления, затем введите нужные адреса контактов, либо нажмите ссылку «Выбрать из базы подписчиков» внизу поля;
     ![How to add subscribers from base](/img/automations/automation-with-workflows/workflow-guide/how-to-add-subscribers-from-base.gif)
...
- Выберите нужный сценарий из&nbsp;списка в&nbsp;разделе **Автоматизации → Сценарии**, нажмите на кнопку «Редактировать» и&nbsp;выберите пункт **Создать копию**:
