...
:::tip Важно
Подключение автоматизации приостановлено. В ближайшее время вы сможете настроить товарные рекомендации в новом модуле Sendsay Продажи — оставьте заявку, чтобы получить ранний доступ к новым возможностям. [Подробнее](https://app.sendsay.ru/ecom)
