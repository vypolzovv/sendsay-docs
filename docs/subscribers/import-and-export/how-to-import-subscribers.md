...
![Check if the data is displayed correctly](./assets\how-to-import-subscribers/check-if-the-data-is-displayed-correctly.gif) <br/>
...
![Select fields to store data](./assets\how-to-import-subscribers/select-fields-to-store-data.gif) <br/>
...
![Select list for data](./assets\how-to-import-subscribers/select-list-for-data.gif) <br/>
