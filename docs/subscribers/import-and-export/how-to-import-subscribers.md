...
import importDetails from "/img/subscribers/import-and-export/how-to-import-subscribers/import-details1.png"
...
Отчёт об импорте можно посмотреть в **[Журнале заданий](https://app.sendsay.ru/queue)**: для этого наведите курсор на область рядом с названием импорта. А чтобы открыть полный отчёт, нажмите на кнопку «Детали»:
...
Посмотреть доступные тарифы и узнать о лимитах можно в [калькуляторе тарифов](https://sendsay.ru/rates#null).
:::
